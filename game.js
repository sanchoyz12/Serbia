const storyData = {
    start: {
        ...
        text: "Шумный терминал C. Последний взгляд на табло вылетов. В чемодане — всё, что успел собрать за неделю, в кармане — остатки сбережений. Аэроэкспресс остался позади, впереди — неизвестность. Ты стоишь у гейта. Что ты чувствуешь?",
        image: "bg.png",
        choices: [
    ...
    hostel_checkin: {
        ...
        text: "В хостеле тебя встречает Драган. Он сразу наливает стопку. 'Ракыя! Из подмосковных яблок? Нет, это наша сербская слива! Живели!'.",
        choices: [
    ...
    boravak_process: {
        ...
        choices: [
            { text: "Она у меня есть из Москвы!", next: "ending_success" },
...
class Game {
    ...
    handleChoice(choice) {
        ...
        if (this.stress >= 100) {
            this.triggerGameOver("Твои нервы сдали. Ты купил обратный билет в Москву.");
            return;
        }
